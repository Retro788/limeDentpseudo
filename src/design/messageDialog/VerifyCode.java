...
public class VerifyCode extends JDialog {
	...
	private void initComponents() {
		...
		btnCancelar.setBackground( new Color( 146 , 20 , 12 ) );
		btnCancelar.setForeground( new Color( 244 , 244 , 249 ) );
		btnCancelar.setText( "Cancelar" );
		btnCancelar.setRound( 15 );
		btnCancelar.setFocusPainted( false );
		btnCancelar.setFont( new Font( "Century Gothic" , Font.BOLD , 15 ) );
		...
		txt.setLabelText( "Ingrese el código del correo" );
			...
			public void focusLost( FocusEvent e ) {
				...
				if ( !txt.getText().equals( "" ) ) {
					...
					if ( !checkCode( txt.getText() ) ) {
						...
						txt.requestFocus();
						txt.selectAll();
						txt.setHelperText( "Introduzca un código válido." );
		...
		background1Layout.setHorizontalGroup( background1Layout.createParallelGroup( GroupLayout.Alignment.LEADING )
				.addGroup( background1Layout.createSequentialGroup()
						.addComponent( btnCancelar , GroupLayout.DEFAULT_SIZE , 195 , Short.MAX_VALUE )
		...
		background1Layout.setVerticalGroup( background1Layout.createParallelGroup( GroupLayout.Alignment.LEADING )
				.addGroup( GroupLayout.Alignment.TRAILING , background1Layout.createSequentialGroup()
						...
						.addGroup( background1Layout.createParallelGroup( GroupLayout.Alignment.BASELINE )
								.addComponent( btnCancelar , GroupLayout.PREFERRED_SIZE , 50 ,
	...
	private boolean checkCode( String code ) {
		...
		if ( !isCodeValid ) {
			...
			txt.setHelperText( "El código debe contener solo números." );
