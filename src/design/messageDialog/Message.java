...
public class Message extends JPanel {
	...
	private void cmdCancelActionPerformed( ActionEvent evt ) {
       ...
       /**
        * Registra la acción para el botón "Aceptar" y cierra la ventana
        * emergente al finalizar la ejecución del oyente proporcionado.
        *
        * @param event acción a ejecutar cuando se presiona "Aceptar".
        */
