...
import view.viewPanel.extra.PersonalInfoPanel;
import view.viewPanel.extra.PracticesPanel;
import view.viewPanel.extra.PublicationsPanel;
import view.viewPanel.extra.AgendaPanel;
import view.viewPanel.extra.ReviewsPanel;
import view.View;
...
public class CardPanel extends RoundedPanel {
	...
	private CardLayout cl;
        ...
        private PracticesPanel practicesPanel;
        ...
        private JScrollPane personalInfoScroll;
        private JScrollPane practicesScroll;
        private JScrollPane publicationsScroll;
	...
	private void initComponents() {
                ...
                personalInfoPanel = new PersonalInfoPanel( this , view );
                practicesPanel = new PracticesPanel( this , view );
                publicationsPanel = new PublicationsPanel( this , view );
                agendaPanel = new AgendaPanel( this , view );
                reviewsPanel = new ReviewsPanel( this , view );
                ...
                personalInfoScroll = createScrollPane( personalInfoPanel );
                practicesScroll = createScrollPane( practicesPanel );
                publicationsScroll = createScrollPane( publicationsPanel );
                agendaScroll = createScrollPane( agendaPanel );
                reviewsScroll = createScrollPane( reviewsPanel );
	...
	private void initLayout() {
                ...
                add( personalInfoScroll , "personalInfoPanel" );
                add( practicesScroll , "practicesPanel" );
                add( publicationsScroll , "publicationsPanel" );
                add( agendaScroll , "agendaPanel" );
                add( reviewsScroll , "reviewsPanel" );
		...
		switch (card) {
			...
			case "ponudePanel":
				...
				break;
                        ...
                        case "personalInfoPanel":
                                personalInfoPanel.clearAll();
                                break;

                        case "practicesPanel":
                                practicesPanel.clearAll();
                                break;

                        case "publicationsPanel":
                                publicationsPanel.clearAll();
                                break;

                        case "agendaPanel":
                                agendaPanel.clearAll();
                                break;

                        case "reviewsPanel":
                                reviewsPanel.clearAll();
                                break;
