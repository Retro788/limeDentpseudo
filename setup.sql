...
INSERT INTO patients (imePrezime, mail, phone, oib, jmbg, patientAddress, patientCity, patientMedicalHistory, patientAlergies) VALUES
('Juan Pérez', 'juan.perez@example.com', '555123456', 87654321, 1234567890123, 'Calle Mayor 123', 'Madrid', 'Sin antecedentes', 'Ninguna'),
('María López', 'maria.lopez@example.com', '555987654', 87654322, 1234567890124, 'Gran Vía 10', 'Barcelona', 'Alergia a penicilina', 'Penicilina');
